try{
    node {
        ...
        stage 'Build'
            sh 'docker build --build-arg NODE_ENV=development --build-arg THEIA_AUTH_SECRET=$(cat /run/secrets/api.authKey) -t 315915642113.dkr.ecr.us-east-1.amazonaws.com/dev-theia .'
